...
const spellIds = [3] // Replace with the spell IDs you want to scrape

// eslint-disable-next-line space-before-function-paren
async function scrapeSpell(spellId) {
  const url = `https://2e.aonprd.com/Spells.aspx?ID=${spellId}`
